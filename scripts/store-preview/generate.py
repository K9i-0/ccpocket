...
<div class="note"><strong>内容承認済み — iOSは審査待ち。Androidはビルドの追加送信待ち。</strong><p>対象：1.127.2（244）。両ストアの説明文・画像はアップロード済みです。Androidではストア情報が審査中で、ビルド244のリリースは保存済みです。審査中の変更への追加送信は自動承認レビューで停止しました。</p><p>両ストアとも審査承認後は手動公開です。<a href="submission.txt" target="_blank">提出状況・対象ref・SHA・全言語リリースノート</a></p><p><a href="https://github.com/K9i-0/ccpocket/actions/runs/33936612925">画像・文面のアップロード成功</a> · <a href="https://github.com/K9i-0/ccpocket/actions/runs/33936733459">審査提出の実行結果</a></p></div>
