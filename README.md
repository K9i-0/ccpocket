...
The native app is recommended for Mac users because it is optimized for macOS. Download the latest `.dmg` from [GitHub Releases](https://github.com/K9i-0/ccpocket/releases?q=macos) (look for releases tagged `macos/v*`).
