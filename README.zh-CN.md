...
CC Pocket 是一款可以让你只用手机就启动并完成 Claude / Codex 会话的应用。不需要打开笔记本电脑，只要打开 App、选择项目，就能随时随地开始编码。
...
CC Pocket 就是围绕这种工作方式设计的：你在手机上发起会话，让自己机器上的 Claude / Codex 在后台执行，而你无论身在何处，都可以只做关键决策。
