...
// Process status
 ...
 ExecutionMode get executionMode; CodexApprovalPolicy get codexApprovalPolicy; String get codexApprovalsReviewer; bool get planMode;// Sandbox mode — Freezed default is .on but Cubit constructor overrides
...
switch (_that) {
case _ChatSessionState() when $default != null:
return $default(_that.status,_that.entries,_that.approval,_that.claudeSessionId,_that.projectPath,_that.gitBranch,_that.explorerCurrentPath,_that.recentPeekedFiles,_that.pastHistoryLoaded,_that.bulkLoading,_that.inPlanMode,_that.collapseToolResults,_that.permissionMode,_that.executionMode,_that.codexApprovalPolicy,_that.codexApprovalsReviewer,_that.planMode,_that.sandboxMode,_that.hiddenToolUseIds,_that.rewindPreview,_that.totalCost,_that.totalDuration,_that.slashCommands,_that.queuedInput);case _:
  return orElse();
...
@override
int get hashCode => Object.hashAll([runtimeType,status,const DeepCollectionEquality().hash(_entries),approval,claudeSessionId,projectPath,gitBranch,explorerCurrentPath,const DeepCollectionEquality().hash(_recentPeekedFiles),pastHistoryLoaded,bulkLoading,inPlanMode,collapseToolResults,permissionMode,executionMode,codexApprovalPolicy,codexApprovalsReviewer,planMode,sandboxMode,const DeepCollectionEquality().hash(_hiddenToolUseIds),rewindPreview,totalCost,totalDuration,const DeepCollectionEquality().hash(_slashCommands),queuedInput]);
