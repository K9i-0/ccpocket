...
// Process status
 ...
 bool get pastHistoryLoaded; bool get bulkLoading; bool get inPlanMode; bool get collapseToolResults;// Cost tracking
...
@override
int get hashCode => Object.hash(runtimeType,status,const DeepCollectionEquality().hash(entries),approval,claudeSessionId,projectPath,gitBranch,pastHistoryLoaded,bulkLoading,inPlanMode,collapseToolResults,totalCost,totalDuration,const DeepCollectionEquality().hash(slashCommands));

@override
String toString() {
  return 'ChatSessionState(status: $status, entries: $entries, approval: $approval, claudeSessionId: $claudeSessionId, projectPath: $projectPath, gitBranch: $gitBranch, pastHistoryLoaded: $pastHistoryLoaded, bulkLoading: $bulkLoading, inPlanMode: $inPlanMode, collapseToolResults: $collapseToolResults, totalCost: $totalCost, totalDuration: $totalDuration, slashCommands: $slashCommands)';
}
...
@useResult
$Res call({
 ProcessStatus status, List<ChatEntry> entries, ApprovalState approval, String? claudeSessionId, String? projectPath, String? gitBranch, bool pastHistoryLoaded, bool bulkLoading, bool inPlanMode, bool collapseToolResults, double totalCost, Duration? totalDuration, List<SlashCommand> slashCommands
});
...
as bool,totalCost: null == totalCost ? _self.totalCost : totalCost // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( ProcessStatus status,  List<ChatEntry> entries,  ApprovalState approval,  String? claudeSessionId,  String? projectPath,  String? gitBranch,  bool pastHistoryLoaded,  bool bulkLoading,  bool inPlanMode,  bool collapseToolResults,  double totalCost,  Duration? totalDuration,  List<SlashCommand> slashCommands)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ChatSessionState() when $default != null:
return $default(_that.status,_that.entries,_that.approval,_that.claudeSessionId,_that.projectPath,_that.gitBranch,_that.pastHistoryLoaded,_that.bulkLoading,_that.inPlanMode,_that.collapseToolResults,_that.totalCost,_that.totalDuration,_that.slashCommands);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( ProcessStatus status,  List<ChatEntry> entries,  ApprovalState approval,  String? claudeSessionId,  String? projectPath,  String? gitBranch,  bool pastHistoryLoaded,  bool bulkLoading,  bool inPlanMode,  bool collapseToolResults,  double totalCost,  Duration? totalDuration,  List<SlashCommand> slashCommands)  $default,) {final _that = this;
switch (_that) {
case _ChatSessionState():
return $default(_that.status,_that.entries,_that.approval,_that.claudeSessionId,_that.projectPath,_that.gitBranch,_that.pastHistoryLoaded,_that.bulkLoading,_that.inPlanMode,_that.collapseToolResults,_that.totalCost,_that.totalDuration,_that.slashCommands);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( ProcessStatus status,  List<ChatEntry> entries,  ApprovalState approval,  String? claudeSessionId,  String? projectPath,  String? gitBranch,  bool pastHistoryLoaded,  bool bulkLoading,  bool inPlanMode,  bool collapseToolResults,  double totalCost,  Duration? totalDuration,  List<SlashCommand> slashCommands)?  $default,) {final _that = this;
switch (_that) {
case _ChatSessionState() when $default != null:
return $default(_that.status,_that.entries,_that.approval,_that.claudeSessionId,_that.projectPath,_that.gitBranch,_that.pastHistoryLoaded,_that.bulkLoading,_that.inPlanMode,_that.collapseToolResults,_that.totalCost,_that.totalDuration,_that.slashCommands);case _:
  return null;
...
@override
int get hashCode => Object.hash(runtimeType,status,const DeepCollectionEquality().hash(_entries),approval,claudeSessionId,projectPath,gitBranch,pastHistoryLoaded,bulkLoading,inPlanMode,collapseToolResults,totalCost,totalDuration,const DeepCollectionEquality().hash(_slashCommands));
