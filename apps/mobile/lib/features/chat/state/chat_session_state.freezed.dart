...
// Process status
 ...
 bool get pastHistoryLoaded; bool get bulkLoading; bool get inPlanMode; bool get collapseToolResults;// Tool use IDs hidden by tool_use_summary (subagent compression)
 Set<String> get hiddenToolUseIds;// Cost tracking
...
@useResult
$Res call({
 ProcessStatus status, List<ChatEntry> entries, ApprovalState approval, String? claudeSessionId, String? projectPath, String? gitBranch, bool pastHistoryLoaded, bool bulkLoading, bool inPlanMode, bool collapseToolResults, Set<String> hiddenToolUseIds, double totalCost, Duration? totalDuration, List<SlashCommand> slashCommands
});
...
as bool,hiddenToolUseIds: null == hiddenToolUseIds ? _self.hiddenToolUseIds : hiddenToolUseIds // ignore: cast_nullable_to_non_nullable
as Set<String>,totalCost: null == totalCost ? _self.totalCost : totalCost // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( ProcessStatus status,  List<ChatEntry> entries,  ApprovalState approval,  String? claudeSessionId,  String? projectPath,  String? gitBranch,  bool pastHistoryLoaded,  bool bulkLoading,  bool inPlanMode,  bool collapseToolResults,  Set<String> hiddenToolUseIds,  double totalCost,  Duration? totalDuration,  List<SlashCommand> slashCommands)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ChatSessionState() when $default != null:
return $default(_that.status,_that.entries,_that.approval,_that.claudeSessionId,_that.projectPath,_that.gitBranch,_that.pastHistoryLoaded,_that.bulkLoading,_that.inPlanMode,_that.collapseToolResults,_that.hiddenToolUseIds,_that.totalCost,_that.totalDuration,_that.slashCommands);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( ProcessStatus status,  List<ChatEntry> entries,  ApprovalState approval,  String? claudeSessionId,  String? projectPath,  String? gitBranch,  bool pastHistoryLoaded,  bool bulkLoading,  bool inPlanMode,  bool collapseToolResults,  Set<String> hiddenToolUseIds,  double totalCost,  Duration? totalDuration,  List<SlashCommand> slashCommands)  $default,) {final _that = this;
switch (_that) {
case _ChatSessionState():
return $default(_that.status,_that.entries,_that.approval,_that.claudeSessionId,_that.projectPath,_that.gitBranch,_that.pastHistoryLoaded,_that.bulkLoading,_that.inPlanMode,_that.collapseToolResults,_that.hiddenToolUseIds,_that.totalCost,_that.totalDuration,_that.slashCommands);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( ProcessStatus status,  List<ChatEntry> entries,  ApprovalState approval,  String? claudeSessionId,  String? projectPath,  String? gitBranch,  bool pastHistoryLoaded,  bool bulkLoading,  bool inPlanMode,  bool collapseToolResults,  Set<String> hiddenToolUseIds,  double totalCost,  Duration? totalDuration,  List<SlashCommand> slashCommands)?  $default,) {final _that = this;
switch (_that) {
case _ChatSessionState() when $default != null:
return $default(_that.status,_that.entries,_that.approval,_that.claudeSessionId,_that.projectPath,_that.gitBranch,_that.pastHistoryLoaded,_that.bulkLoading,_that.inPlanMode,_that.collapseToolResults,_that.hiddenToolUseIds,_that.totalCost,_that.totalDuration,_that.slashCommands);case _:
  return null;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ChatSessionState&&(identical(other.status, status) || other.status == status)&&const DeepCollectionEquality().equals(other._entries, _entries)&&(identical(other.approval, approval) || other.approval == approval)&&(identical(other.claudeSessionId, claudeSessionId) || other.claudeSessionId == claudeSessionId)&&(identical(other.projectPath, projectPath) || other.projectPath == projectPath)&&(identical(other.gitBranch, gitBranch) || other.gitBranch == gitBranch)&&(identical(other.pastHistoryLoaded, pastHistoryLoaded) || other.pastHistoryLoaded == pastHistoryLoaded)&&(identical(other.bulkLoading, bulkLoading) || other.bulkLoading == bulkLoading)&&(identical(other.inPlanMode, inPlanMode) || other.inPlanMode == inPlanMode)&&(identical(other.collapseToolResults, collapseToolResults) || other.collapseToolResults == collapseToolResults)&&const DeepCollectionEquality().equals(other._hiddenToolUseIds, _hiddenToolUseIds)&&(identical(other.totalCost, totalCost) || other.totalCost == totalCost)&&(identical(other.totalDuration, totalDuration) || other.totalDuration == totalDuration)&&const DeepCollectionEquality().equals(other._slashCommands, _slashCommands));
}


@override
int get hashCode => Object.hash(runtimeType,status,const DeepCollectionEquality().hash(_entries),approval,claudeSessionId,projectPath,gitBranch,pastHistoryLoaded,bulkLoading,inPlanMode,collapseToolResults,const DeepCollectionEquality().hash(_hiddenToolUseIds),totalCost,totalDuration,const DeepCollectionEquality().hash(_slashCommands));
...
as bool,inPlanMode: null == inPlanMode ? _self.inPlanMode : inPlanMode // ignore: cast_nullable_to_non_nullable
as bool,collapseToolResults: null == collapseToolResults ? _self.collapseToolResults : collapseToolResults // ignore: cast_nullable_to_non_nullable
as bool,hiddenToolUseIds: null == hiddenToolUseIds ? _self._hiddenToolUseIds : hiddenToolUseIds // ignore: cast_nullable_to_non_nullable
as Set<String>,totalCost: null == totalCost ? _self.totalCost : totalCost // ignore: cast_nullable_to_non_nullable
as double,totalDuration: freezed == totalDuration ? _self.totalDuration : totalDuration // ignore: cast_nullable_to_non_nullable
