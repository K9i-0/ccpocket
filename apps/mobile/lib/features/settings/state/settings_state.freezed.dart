...
/// Empty string means use device default.
 ...
 UsageDisplayMode get usageDisplayMode;/// Whether the remaining weekly Codex quota is shown in Codex chat headers.
 bool get showCodexUsageInChatHeader;/// Whether new Codex sessions should be automatically named after the first turn.
...
as UsageDisplayMode,showCodexUsageInChatHeader: null == showCodexUsageInChatHeader ? _self.showCodexUsageInChatHeader : showCodexUsageInChatHeader // ignore: cast_nullable_to_non_nullable
as bool,autoRenameCodexSessions: null == autoRenameCodexSessions ? _self.autoRenameCodexSessions : autoRenameCodexSessions // ignore: cast_nullable_to_non_nullable
...
switch (_that) {
case _SettingsState() when $default != null:
return $default(_that.themeMode,_that.appLocaleId,_that.speechLocaleId,_that.fcmEnabledMachines,_that.fcmPrivacyMachines,_that.activeMachineId,_that.fcmAvailable,_that.fcmSyncInProgress,_that.fcmStatusKey,_that.shorebirdTrack,_that.indentSize,_that.textScale,_that.codeFontSize,_that.codeFontFamily,_that.hideVoiceInput,_that.openGalleryDirectly,_that.imagePasteShortcut,_that.gitDiffInteractionMode,_that.gitDiffFocusAutoLandscape,_that.showRemoteGitStatusBadge,_that.showBridgeNameInSessionList,_that.selectedAppIcon,_that.appIconSupported,_that.terminalApp,_that.newSessionTabs,_that.showHiddenDirectories,_that.usageDisplayMode,_that.showCodexUsageInChatHeader,_that.autoRenameCodexSessions,_that.showExtendedCodexEfforts,_that.autoRenameClaudeSessions);case _:
  return orElse();
...
class _SettingsState extends SettingsState {
  const _SettingsState({this.themeMode = ThemeMode.system, this.appLocaleId = '', this.speechLocaleId = '',  Set<String> fcmEnabledMachines = const {},  Set<String> fcmPrivacyMachines = const {}, this.activeMachineId, this.fcmAvailable = false, this.fcmSyncInProgress = false, this.fcmStatusKey, this.shorebirdTrack = 'stable', this.indentSize = 2, this.textScale = 1.0, this.codeFontSize = 12.0, this.codeFontFamily = CodeFontFamily.jetBrainsMono, this.hideVoiceInput = false, this.openGalleryDirectly = false, this.imagePasteShortcut = ImagePasteShortcut.ctrlV, this.gitDiffInteractionMode = GitDiffInteractionMode.quickActions, this.gitDiffFocusAutoLandscape = false, this.showRemoteGitStatusBadge = false, this.showBridgeNameInSessionList = true, this.selectedAppIcon = AppIconVariant.defaultIcon, this.appIconSupported = false, this.terminalApp = TerminalAppConfig.empty,  List<NewSessionTab> newSessionTabs = defaultNewSessionTabs, this.showHiddenDirectories = false, this.usageDisplayMode = UsageDisplayMode.remaining, this.showCodexUsageInChatHeader = false, this.autoRenameCodexSessions = true, this.showExtendedCodexEfforts = false, this.autoRenameClaudeSessions = false}): _fcmEnabledMachines = fcmEnabledMachines,_fcmPrivacyMachines = fcmPrivacyMachines,_newSessionTabs = newSessionTabs,super._();
...
@override@JsonKey() final  bool showCodexUsageInChatHeader;
...
@override
int get hashCode => Object.hashAll([runtimeType,themeMode,appLocaleId,speechLocaleId,const DeepCollectionEquality().hash(_fcmEnabledMachines),const DeepCollectionEquality().hash(_fcmPrivacyMachines),activeMachineId,fcmAvailable,fcmSyncInProgress,fcmStatusKey,shorebirdTrack,indentSize,textScale,codeFontSize,codeFontFamily,hideVoiceInput,openGalleryDirectly,imagePasteShortcut,gitDiffInteractionMode,gitDiffFocusAutoLandscape,showRemoteGitStatusBadge,showBridgeNameInSessionList,selectedAppIcon,appIconSupported,terminalApp,const DeepCollectionEquality().hash(_newSessionTabs),showHiddenDirectories,usageDisplayMode,showCodexUsageInChatHeader,autoRenameCodexSessions,showExtendedCodexEfforts,autoRenameClaudeSessions]);
