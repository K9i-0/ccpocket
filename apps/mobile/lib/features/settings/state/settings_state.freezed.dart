...
@override
int get hashCode => Object.hashAll([runtimeType,themeMode,appLocaleId,speechLocaleId,const DeepCollectionEquality().hash(fcmEnabledMachines),const DeepCollectionEquality().hash(fcmPrivacyMachines),activeMachineId,fcmAvailable,fcmSyncInProgress,fcmStatusKey,shorebirdTrack,indentSize,textScale,hideVoiceInput,gitDiffInteractionMode,showRemoteGitStatusBadge,showBridgeNameInSessionList,selectedAppIcon,appIconSupported,terminalApp,const DeepCollectionEquality().hash(newSessionTabs),usageDisplayMode,autoRenameCodexSessions,autoRenameClaudeSessions]);

@override
String toString() {
  return 'SettingsState(themeMode: $themeMode, appLocaleId: $appLocaleId, speechLocaleId: $speechLocaleId, fcmEnabledMachines: $fcmEnabledMachines, fcmPrivacyMachines: $fcmPrivacyMachines, activeMachineId: $activeMachineId, fcmAvailable: $fcmAvailable, fcmSyncInProgress: $fcmSyncInProgress, fcmStatusKey: $fcmStatusKey, shorebirdTrack: $shorebirdTrack, indentSize: $indentSize, textScale: $textScale, hideVoiceInput: $hideVoiceInput, gitDiffInteractionMode: $gitDiffInteractionMode, showRemoteGitStatusBadge: $showRemoteGitStatusBadge, showBridgeNameInSessionList: $showBridgeNameInSessionList, selectedAppIcon: $selectedAppIcon, appIconSupported: $appIconSupported, terminalApp: $terminalApp, newSessionTabs: $newSessionTabs, usageDisplayMode: $usageDisplayMode, autoRenameCodexSessions: $autoRenameCodexSessions, autoRenameClaudeSessions: $autoRenameClaudeSessions)';
}
...
@useResult
$Res call({
 ThemeMode themeMode, String appLocaleId, String speechLocaleId, Set<String> fcmEnabledMachines, Set<String> fcmPrivacyMachines, String? activeMachineId, bool fcmAvailable, bool fcmSyncInProgress, FcmStatusKey? fcmStatusKey, String shorebirdTrack, int indentSize, double textScale, bool hideVoiceInput, GitDiffInteractionMode gitDiffInteractionMode, bool showRemoteGitStatusBadge, bool showBridgeNameInSessionList, AppIconVariant selectedAppIcon, bool appIconSupported, TerminalAppConfig terminalApp, List<NewSessionTab> newSessionTabs, UsageDisplayMode usageDisplayMode, bool autoRenameCodexSessions, bool autoRenameClaudeSessions
});
...
switch (_that) {
case _SettingsState() when $default != null:
return $default(_that.themeMode,_that.appLocaleId,_that.speechLocaleId,_that.fcmEnabledMachines,_that.fcmPrivacyMachines,_that.activeMachineId,_that.fcmAvailable,_that.fcmSyncInProgress,_that.fcmStatusKey,_that.shorebirdTrack,_that.indentSize,_that.textScale,_that.hideVoiceInput,_that.gitDiffInteractionMode,_that.showRemoteGitStatusBadge,_that.showBridgeNameInSessionList,_that.selectedAppIcon,_that.appIconSupported,_that.terminalApp,_that.newSessionTabs,_that.usageDisplayMode,_that.autoRenameCodexSessions,_that.autoRenameClaudeSessions);case _:
  return orElse();
...
class _SettingsState extends SettingsState {
  const _SettingsState({this.themeMode = ThemeMode.system, this.appLocaleId = '', this.speechLocaleId = '', final  Set<String> fcmEnabledMachines = const {}, final  Set<String> fcmPrivacyMachines = const {}, this.activeMachineId, this.fcmAvailable = false, this.fcmSyncInProgress = false, this.fcmStatusKey, this.shorebirdTrack = 'stable', this.indentSize = 2, this.textScale = 1.0, this.hideVoiceInput = false, this.gitDiffInteractionMode = GitDiffInteractionMode.quickActions, this.showRemoteGitStatusBadge = false, this.showBridgeNameInSessionList = true, this.selectedAppIcon = AppIconVariant.defaultIcon, this.appIconSupported = false, this.terminalApp = TerminalAppConfig.empty, final  List<NewSessionTab> newSessionTabs = defaultNewSessionTabs, this.usageDisplayMode = UsageDisplayMode.remaining, this.autoRenameCodexSessions = true, this.autoRenameClaudeSessions = false}): _fcmEnabledMachines = fcmEnabledMachines,_fcmPrivacyMachines = fcmPrivacyMachines,_newSessionTabs = newSessionTabs,super._();
...
@override
int get hashCode => Object.hashAll([runtimeType,themeMode,appLocaleId,speechLocaleId,const DeepCollectionEquality().hash(_fcmEnabledMachines),const DeepCollectionEquality().hash(_fcmPrivacyMachines),activeMachineId,fcmAvailable,fcmSyncInProgress,fcmStatusKey,shorebirdTrack,indentSize,textScale,hideVoiceInput,gitDiffInteractionMode,showRemoteGitStatusBadge,showBridgeNameInSessionList,selectedAppIcon,appIconSupported,terminalApp,const DeepCollectionEquality().hash(_newSessionTabs),usageDisplayMode,autoRenameCodexSessions,autoRenameClaudeSessions]);
