...
/// Empty string means use device default.
 ...
 GitDiffInteractionMode get gitDiffInteractionMode;/// Whether to show a subtle badge when the current branch can push/pull.
 bool get showRemoteGitStatusBadge;/// Selected app icon preference for monthly Supporter perks.
...
@useResult
$Res call({
 ThemeMode themeMode, String appLocaleId, String speechLocaleId, Set<String> fcmEnabledMachines, Set<String> fcmPrivacyMachines, String? activeMachineId, bool fcmAvailable, bool fcmSyncInProgress, FcmStatusKey? fcmStatusKey, String shorebirdTrack, int indentSize, double textScale, bool hideVoiceInput, GitDiffInteractionMode gitDiffInteractionMode, bool showRemoteGitStatusBadge, AppIconVariant selectedAppIcon, bool appIconSupported, TerminalAppConfig terminalApp, List<NewSessionTab> newSessionTabs, UsageDisplayMode usageDisplayMode, bool autoRenameCodexSessions, bool autoRenameClaudeSessions
});
...
/// Create a copy of SettingsState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? themeMode = null,Object? appLocaleId = null,Object? speechLocaleId = null,Object? fcmEnabledMachines = null,Object? fcmPrivacyMachines = null,Object? activeMachineId = freezed,Object? fcmAvailable = null,Object? fcmSyncInProgress = null,Object? fcmStatusKey = freezed,Object? shorebirdTrack = null,Object? indentSize = null,Object? textScale = null,Object? hideVoiceInput = null,Object? gitDiffInteractionMode = null,Object? showRemoteGitStatusBadge = null,Object? selectedAppIcon = null,Object? appIconSupported = null,Object? terminalApp = null,Object? newSessionTabs = null,Object? usageDisplayMode = null,Object? autoRenameCodexSessions = null,Object? autoRenameClaudeSessions = null,}) {
...
as GitDiffInteractionMode,showRemoteGitStatusBadge: null == showRemoteGitStatusBadge ? _self.showRemoteGitStatusBadge : showRemoteGitStatusBadge // ignore: cast_nullable_to_non_nullable
...
switch (_that) {
case _SettingsState() when $default != null:
return $default(_that.themeMode,_that.appLocaleId,_that.speechLocaleId,_that.fcmEnabledMachines,_that.fcmPrivacyMachines,_that.activeMachineId,_that.fcmAvailable,_that.fcmSyncInProgress,_that.fcmStatusKey,_that.shorebirdTrack,_that.indentSize,_that.textScale,_that.hideVoiceInput,_that.gitDiffInteractionMode,_that.showRemoteGitStatusBadge,_that.selectedAppIcon,_that.appIconSupported,_that.terminalApp,_that.newSessionTabs,_that.usageDisplayMode,_that.autoRenameCodexSessions,_that.autoRenameClaudeSessions);case _:
  return orElse();
...
class _SettingsState extends SettingsState {
  const _SettingsState({this.themeMode = ThemeMode.system, this.appLocaleId = '', this.speechLocaleId = '', final  Set<String> fcmEnabledMachines = const {}, final  Set<String> fcmPrivacyMachines = const {}, this.activeMachineId, this.fcmAvailable = false, this.fcmSyncInProgress = false, this.fcmStatusKey, this.shorebirdTrack = 'stable', this.indentSize = 2, this.textScale = 1.0, this.hideVoiceInput = false, this.gitDiffInteractionMode = GitDiffInteractionMode.quickActions, this.showRemoteGitStatusBadge = false, this.selectedAppIcon = AppIconVariant.defaultIcon, this.appIconSupported = false, this.terminalApp = TerminalAppConfig.empty, final  List<NewSessionTab> newSessionTabs = defaultNewSessionTabs, this.usageDisplayMode = UsageDisplayMode.remaining, this.autoRenameCodexSessions = true, this.autoRenameClaudeSessions = false}): _fcmEnabledMachines = fcmEnabledMachines,_fcmPrivacyMachines = fcmPrivacyMachines,_newSessionTabs = newSessionTabs,super._();
