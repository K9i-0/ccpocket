...
class _SettingsState extends SettingsState {
  const _SettingsState({this.themeMode = ThemeMode.system, this.appLocaleId = '', this.speechLocaleId = '',  Set<String> fcmEnabledMachines = const {},  Set<String> fcmPrivacyMachines = const {}, this.activeMachineId, this.fcmAvailable = false, this.fcmSyncInProgress = false, this.fcmStatusKey, this.shorebirdTrack = 'stable', this.indentSize = 2, this.textScale = 1.0, this.codeFontSize = 12.0, this.codeFontFamily = CodeFontFamily.jetBrainsMono, this.hideVoiceInput = false, this.imagePasteShortcut = ImagePasteShortcut.ctrlV, this.gitDiffInteractionMode = GitDiffInteractionMode.quickActions, this.gitDiffFocusAutoLandscape = false, this.showRemoteGitStatusBadge = false, this.showBridgeNameInSessionList = true, this.selectedAppIcon = AppIconVariant.defaultIcon, this.appIconSupported = false, this.terminalApp = TerminalAppConfig.empty,  List<NewSessionTab> newSessionTabs = defaultNewSessionTabs, this.showHiddenDirectories = false, this.usageDisplayMode = UsageDisplayMode.remaining, this.autoRenameCodexSessions = true, this.showExtendedCodexEfforts = false, this.autoRenameClaudeSessions = false}): _fcmEnabledMachines = fcmEnabledMachines,_fcmPrivacyMachines = fcmPrivacyMachines,_newSessionTabs = newSessionTabs,super._();
