...
**EN**: Mobile client for Claude Code and Codex coding agents
**JA**: Claude Code / Codex対応のモバイルクライアント
...
- Real-time chat with Claude Code and Codex (streaming)
...
claude,code,codex,ai,coding,agent,mobile,bridge,ssh,remote
